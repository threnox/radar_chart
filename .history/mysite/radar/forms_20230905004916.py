...
region = [('empty', '選択してください'), ('LCK', 'LCK'), ('LEC', 'LEC'), ('LJL', 'LJL')]
season = [('empty', '選択してください'), ('Winter', 'Winter (LEC Only) '), ('Spring', 'Spring'), ('Summer', 'Summer')]
games = [(1, 1), (2, 2)]
...
class ParameterForm(forms.Form):
    ...
    min_games = forms.IntegerField(widget=forms.NumberInput, 
                                   choices=games, 
                                #    max_value=9, min_value=3, 
                                   initial=3, label='min games')