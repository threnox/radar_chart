        ...
        if 'generate' in request.POST:
            ...
            if form.is_valid():
                ...
                if position == 'top':
                    ...
                    top.create_radar()
                    request.session['radar_image'] = '/static/radar/images/radar_image' + crc.TopRadar.rnd + '.png'
                elif position == 'jungle':
                    jng = crc.JngRadar(league, split, min_game_count)
                    jng.create_radar()
                    request.session['radar_image'] = '/static/radar/images/radar_image' + crc.JngRadar.rnd + '.png'
                elif position == 'mid':
                    mid = crc.MidRadar(league, split, min_game_count)
                    mid.create_radar()
                    request.session['radar_image'] = '/static/radar/images/radar_image' + crc.MidRadar.rnd + '.png'
                elif position == 'bot':
                    bot = crc.BotRadar(league, split, min_game_count)
                    bot.create_radar()
                    request.session['radar_image'] = '/static/radar/images/radar_image' + crc.BotRadar.rnd + '.png'
                elif position == 'support':
                    sup = crc.SupRadar(league, split, min_game_count)
                    sup.create_radar()
                    request.session['radar_image'] = '/static/radar/images/radar_image' + crc.SupRadar.rnd + '.png'
